...
module.exports = async function (fastify, options) {
  ...
  const statuses = _.map(['ENABLED', 'DISABLED', 'BANNED', 'NEWPWREQ', 'AWAITACTV'],
    s => ({ model: 'auth-user', name: s, column: 'status' }))
  await fastify.ndutDb.model.DbLookup.create(statuses)
